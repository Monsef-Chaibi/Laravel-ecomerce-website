                        ...
                        @foreach ($commande->lignecommandes as $c)
                            <tr>
                                <td class="align-middle"><img src="img/product-1.jpg" alt=""
                                        style="width: 50px;">{{ $c->produit->name }}     <img style="width: 15%;height:15%" src="{{ asset('Image_upload') }}/{{ $c->produit->image }}" alt=""> </td>
                                <td class="align-middle">{{ $c->produit->prix }}</td>
                                <td class="align-middle">
                                    <div class="input-group quantity mx-auto" style="width: 100px;">
                                        {{ $c->qte }}
                                    </div>
                                </td>
                                <td class="align-middle">{{ $c->produit->prix * $c->qte }} $</td>
                                <td class="align-middle">
                                    <a href="/DeleteCommande/{{$c->id}}" class="btn btn-primary"><i class="fa fa-times "></i></a></td>
                            </tr>
                        @endforeach
                    </tbody>
                </table>
                ...
                <div class="card border-secondary mb-5">
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between mb-3 pt-1">
                            ...
                            <h6 class="font-weight-medium">{{$commande->Totalprix()}} $</h6>
                        </div>
                    ...
                    <div class="card-footer border-secondary bg-transparent">
                        <div class="d-flex justify-content-between mt-2">
                            ...
                            <h5 class="font-weight-bold"> {{$commande->Totalprix()+10}}</h5>
                        </div>
