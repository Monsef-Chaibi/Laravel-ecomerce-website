                    ...
                    <div class="mb-4">
                        ...
                        <div class="row">
                            <div class="col-md-6 form-group">
                                ...
                                <input class="form-control" type="text" name="name1" placeholder="First Name">
                            </div>
                            <div class="col-md-6 form-group">
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <input class="form-control" type="text" name="mob" placeholder="+212 ...">
                            </div>
                            <div class="col-md-6 form-group">
                                <label>Address</label>
                                <input class="form-control" type="text" name="adress" placeholder="123 Street">
                            </div>
                            <div class="col-md-6 form-group">
                                <label>Country</label>
