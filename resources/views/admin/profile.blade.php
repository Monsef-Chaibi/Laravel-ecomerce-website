    ...
    <main class="main" id="top">
      <div class="container-fluid px-0">
        ...
        <div class="content">
          <div class="pb-5">
            <div class="row g-5">
              <h3 class="text-primary">Modidier Profile</h3>
              <hr>
            ...
            <form action="/Profile/Modidier" method="post">
              ...
              @foreach ($user as $u)
              <div class="mb-3 row">
                <label class="col-sm-2 col-form-label" for="staticEmail">Id</label>
                  <div class="col-sm-10">
                    <input class="form-control-plaintext outline-none" id="staticEmail" type="text"  readonly="" value="{{$u->id}}">
